...
const googleSans = localFont({ src: "./fonts/GoogleSans-Regular.woff" });
function GDGoCLogo() {
  return (
    <svg
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>Build With AI: LangChain + Next.js Template</title>
        ...
        <meta
          property="og:title"
          content="Build With AI: LangChain + Next.js Template"
        />
        <meta
          ...
          <div className="bg-secondary grid grid-rows-[auto,1fr] h-[100dvh]">
            <div className="grid grid-cols-[1fr,auto] gap-2 p-4">
              <div className="flex gap-4 flex-col md:flex-row md:items-center">
                <a
                  href="https://ai.google/get-started/for-developers/"
                  rel="noopener noreferrer"
                  target="_blank"
                  className="flex items-center gap-2"
                >
                  <Image
                    src={"/images/bwai-logo.png"}
                    alt="Build With AI"
                    height={128}
                    width={128}
              ...
              <div className="flex justify-center gap-2 items-center">
                <Button asChild variant="outline" size="default">
                  <a
                    href="https://gdg.community.dev/gdg-on-campus-sriwijaya-state-polytechnic-palembang-indonesia/"
                    target="_blank"
                  >
                    <GDGoCLogo />
                    <span>Join Our Other Events!</span>
                  </a>
                </Button>
              </div>
            </div>
